import { b as true_default, y as transition_slide_display } from "./warnings-Cy2Rahnz.js";
...
function crossfade({ fallback, ...defaults }) {
	...
	* @returns {TransitionConfig}
	*/
	function crossfade$1(from_node, node, params) {
		const { delay = 0, duration = (d$1) => Math.sqrt(d$1) * 30, easing = cubic_out } = assign(assign({}, defaults), params);
		...
		return (node, params) => {
			...
			return () => {
				if (counterparts.has(params.key)) {
					...
					return crossfade$1(other_node, node, params);
				}
