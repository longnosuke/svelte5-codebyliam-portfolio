...
import { Dt as state, H as render_effect, Qr as noop, Tt as set, Ur as deferred, _n as tag, h as get } from "./events-BQxqNMma.js";
import "./flags-BgGdpxNo.js";
import { Ft as loop, It as raf, j as writable } from "./index-client--6723ZK7.js";
import "./legacy-client-DSSwuzXL.js";
import "./clsx-D0Rpik7s.js";
import { y as linear } from "./easing-De5aWVGb.js";
import { t as MediaQuery } from "./index-client-DTiSx7pt.js";
import "./events-106Kd5T9.js";
import "./reactive-value-vbkILJwh.js";
...
function spring(value, opts = {}) {
	...
	*/
	function set$1(new_value, opts$1 = {}) {
		target_value = new_value;
		const token = current_token = {};
		if (value == null || opts$1.hard || spring$1.stiffness >= 1 && spring$1.damping >= 1) {
			cancel_task = true;
			last_time = raf.now();
			...
			inv_mass_recovery_rate = 1 / ((opts$1.soft === true ? .5 : +opts$1.soft) * 60);
			inv_mass = 0;
		}
		if (!task) {
			last_time = raf.now();
	...
	const spring$1 = {
		set: set$1,
		update: (fn, opts$1) => set$1(fn(target_value, value), opts$1),
...
var Spring = class Spring {
	...
	*/
	constructor(value, options = {}) {
		this.#current = true_default ? tag(/* @__PURE__ */ state(value), "Spring.current") : /* @__PURE__ */ state(value);
		this.#target = true_default ? tag(/* @__PURE__ */ state(value), "Spring.target") : /* @__PURE__ */ state(value);
	...
	*/
	static of(fn, options) {
		const spring$1 = new Spring(fn(), options);
		render_effect(() => {
			spring$1.set(fn());
		});
		return spring$1;
...
function tweened(value, defaults = {}) {
	...
	*/
	...
	return {
		set: set$1,
		update: (fn, opts) => set$1(fn(target_value, value), opts),
		subscribe: store.subscribe
	};
}
/**
...
* @since 5.7.0
*/
const prefersReducedMotion = /* @__PURE__ */ new MediaQuery("(prefers-reduced-motion: reduce)");
