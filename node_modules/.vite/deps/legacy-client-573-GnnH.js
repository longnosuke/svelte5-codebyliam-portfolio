import { _ as state_proxy_unmount, b as true_default, d as legacy_recursive_reactive_block, f as lifecycle_double_unmount, l as hydration_mismatch } from "./warnings-Cy2Rahnz.js";
import { $n as TEMPLATE_FRAGMENT, An as set_hydrate_node, Ar as DOCUMENT_FRAGMENT_NODE, Br as STATE_SYMBOL, Cn as hydrate_next, Ct as mutable_source, Dr as COMMENT_NODE, En as hydrating, Hn as HYDRATION_ERROR, Hr as array_from, Kn as NAMESPACE_MATHML, Lr as LEGACY_PROPS, Mr as EFFECT_RAN, Qr as noop, Sr as lifecycle_outside_component, Tt as set, Un as HYDRATION_START, Ut as boundary, Vn as HYDRATION_END, Vr as TEXT_NODE, Wr as define_property, Xt as flushSync, Yr as is_array, an as dev_current_component_function, at as create_comment, b as set_signal_status, ct as create_text, dn as pop, dt as get_next_sibling, er as TEMPLATE_USE_IMPORT_NODE, fn as push, ft as init_operations, h as get, it as clear_text_content, jn as set_hydrating, k as component_root, kr as DIRTY, l as root_event_handles, mt as set_attribute, nr as TEMPLATE_USE_SVG, o as handle_event_propagation, ot as create_element, pr as hydration_failed, pt as is_firefox, q as user_pre_effect, qn as NAMESPACE_SVG, rn as component_context, s as on, st as create_fragment, t as all_registered_events, tr as TEMPLATE_USE_MATHML, u as active_effect, ut as get_first_child, wn as hydrate_node, zn as FILENAME, zr as MAYBE_DIRTY } from "./events-BumxY3U6.js";
import { t as async_mode_flag } from "./flags-BwKXtxQs.js";
...
function append(anchor, dom) {
	if (hydrating) {
		var effect = active_effect;
		if ((effect.f & EFFECT_RAN) === 0 || effect.nodes.end === null) effect.nodes.end = hydrate_node;
		hydrate_next();
		return;
	}
...
//# sourceMappingURL=legacy-client-573-GnnH.js.map